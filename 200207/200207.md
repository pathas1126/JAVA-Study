...
- 자료 구조를 A에서 B로 바꾸면 출력문까지 전부 수정해야하지만
...
| 메소드              | 설명                                                         |
| :------------------ | ------------------------------------------------------------ |
| *boolean hasNext()* | iteration이 요소를 가지고 있다면 true 반환                   |
...
| 메소드                      | 설명                                                         |
| --------------------------- | ------------------------------------------------------------ |
| *boolean hasMoreElements()* | 해당 enumeration에 값이 더 있는지 확인<br />enumeration 객체에 하나 이상의 요소를 갖는다면 true 반환 |
