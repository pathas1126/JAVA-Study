...
| *String.valueOf(parameter)*         | String 클래스의 정적 메소드,<br />매개변수로 주어진 객체의 값을 String 문자열로 반환<br />다양한 생성자를 가지고 있기 때문에 기본 자료형은 모두 매개변수로 전달 가능 |
...
public class Company {
	...
	public static void main(String[] args) {
		...
		Manager m1 = new Manager("이세종", 42, "남", 3000, "서울시 강남구", "개발 1과");
         ...
         // sub[] 배열이 Manager의 멤버 변수이기 때문에 객체 생성 후 사용 가능
